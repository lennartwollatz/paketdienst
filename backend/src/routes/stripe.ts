...
router.post('/create-payment-intent', requireAuth, async (req: AuthRequest, res: Response) => {
...
router.post('/confirm-one-time-payment', requireAuth, async (req: AuthRequest, res: Response) => {
  try {
